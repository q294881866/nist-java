 ...
 * @date 2018年3月22日
 */
public abstract class TemplateMatcher extends NIST {

	final int templates[];
	protected final int templateLength;

	protected TemplateMatcher(final int[] templates, final int templateLength) {
	...
	public abstract class SingleMatcher implements Matcher {
		...
		protected SingleMatcher(final int template, final int numberOfBlocks,
